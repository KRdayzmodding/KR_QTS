...
class LaunchInterface(QWidget):
    ...
    def __init__(self, win) -> None:
        ...
        # По умолчанию свёрнуты все три: журнал и есть то, куда смотрят сразу
        # после нажатия кнопки, а каждая раскрытая карточка уводит его за
        # нижний край экрана. Что раскрыть — человек решает сам, и выбор
        # держится до перезапуска.
        self.mods_card.set_open(False)
