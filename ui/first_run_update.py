...
from qfluentwidgets import (
    BodyLabel, CaptionLabel, IndeterminateProgressRing, PushButton,
    StrongBodyLabel,
)
...
class _CheckDialog(ThemedDialog):
    ...
    def __init__(self, parent: QWidget | None = None):
        ...
        layout.addWidget(StrongBodyLabel(
            tr("upd.check_head", "Смотрим, нет ли версии новее")))
        note = BodyLabel(tr("upd.check_body",
...
def _apply(rel: Release, parent: QWidget | None) -> bool:
    ...
    _tell(parent, tr("upd.must_failed",
                     "Обновление установить не удалось: {m}\n\n"
...
def ensure_current(parent: QWidget | None = None) -> bool:
    ...
    if not rel.downloadable:
        ...
        _tell(parent, tr("upd.must_noasset",
