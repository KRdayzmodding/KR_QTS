...
class MiniWindow(QWidget):
    ...
    def __init__(self, main_window):
        ...
        self.b_restore.setToolTip(tr("mini.restore_tip",
                                     "Вернуть главное окно приложения"))
    ...
    def _apply_bg(self) -> None:
        ...
        self.setStyleSheet(
            f"QFrame#miniCard{{background-color:{bg};border:1px solid {border};"
            f"border-radius:8px;}}")
    ...
    def sync(self) -> None:
        ...
        for cb, value in ((self.chk_server, bool(p and p.launch_server)),
