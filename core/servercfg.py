...
KNOWN_VARS: dict[str, str] = {
    "hostname": "str", "password": "str", "passwordAdmin": "str",
    "maxPlayers": "int", "verifySignatures": "int", "forceSameBuild": "int",
    "disableVoN": "int", "vonCodecQuality": "int", "disable3rdPerson": "int",
    "disableCrosshair": "int", "serverTime": "str", "serverTimeAcceleration": "int",
    "serverNightTimeAcceleration": "int", "serverTimePersistent": "int",
    "guaranteedUpdates": "int", "loginQueueConcurrentPlayers": "int",
    "loginQueueMaxPlayers": "int", "instanceId": "int", "storageAutoFix": "int",
    "steamQueryPort": "int", "respawnTime": "int", "motdInterval": "int",
    "timeStampFormat": "str", "logAverageFps": "int", "logMemory": "int",
    "logPlayers": "int", "logFile": "str", "adminLogPlayerHitsOnly": "int",
    "adminLogPlacement": "int", "adminLogBuildActions": "int",
    "adminLogPlayerList": "int", "lightingConfig": "int",
    "disablePersonalLight": "int", "disableBaseDamage": "int",
    "disableContainerDamage": "int", "disableRespawnDialog": "int",
    "enableDebugMonitor": "int", "allowFilePatching": "int",
    "simulatedPlayersBatch": "int", "multithreadedReplication": "int",
    "speedhackDetection": "int", "networkRangeClose": "int",
    ...
    def variables(self) -> list[CfgVar]:
        ...
        for m in _VAR_RE.finditer(self.text):
            ...
            out.append(CfgVar(
                ...
                span=(m.start(3), m.end(3)), known=name in KNOWN_VARS,
            ))
        return out
