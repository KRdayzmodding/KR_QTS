...
_TOOLTIPS_RU = {
    ...
    "limitFPS": "Ограничение FPS серверного цикла (снижает нагрузку на CPU).",
    "filePatching": "Разрешает загружать распакованные файлы (сорсы) поверх PBO. Обязателен для отладки без запаковки. Diag-сборки обычно требуют 1.",
